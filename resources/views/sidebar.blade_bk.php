    ...
    <div class="mb-8 border-b border-gray-700 pb-5">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-3 overflow-hidden">
                ...
                @else
                    <div class="w-10 h-10 rounded-xl bg-indigo-600 flex items-center justify-center font-bold text-lg shrink-0">
                        T
                    </div>
                @endif
            ...
            <button @click="open = !open"
                    class="ml-2 bg-gray-800 hover:bg-indigo-600 px-2 py-1 rounded-lg transition">
                ☰
            </button>
